...
public:
    ...
    mapOptimization()
    {
        ...
        // 2021-11-07 11:21
        // std::string ns = "";
        // if (nh.getParam("robot_name", ns))
        // {
        // size_t size = ns.size();
        // robot_id_ = (int)(ns[size - 1]-'0');
        // }
    ...
    void publishOdometry()
    {
        ...
        // tf::StampedTransform trans_odom_to_lidar = tf::StampedTransform(t_odom_to_lidar, timeLaserInfoStamp, "map", "base_link");
